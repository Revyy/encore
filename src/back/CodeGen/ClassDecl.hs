...
instance Translatable (A.Program, A.ClassDecl) (ProgramTable -> CCode FIN) where
  translate (prog, cdecl) table
      | A.isActive cdecl = translateActiveClass prog cdecl table
      | A.isShared cdecl = translateSharedClass prog cdecl table
      | otherwise        = translatePassiveClass prog cdecl table
